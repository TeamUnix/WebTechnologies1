...
\textit{Paulo}\\
These sections is about the optimisation of all the interface for small screen devices. A different technic is needed for web developing to mobile browsers. All the process of optimisation will be described. This web site can be seen by a small device at \textbf{http://ehub.threee.dk/mobile/}
